...
if (isset($_GET['id'])) {
    ...
    $pelangganData = $pelangganController->getPelangganById($id);
    ...
    if ($pelangganData) {
        if (isset($_POST['submit'])) {
            ...
            $result = $pelangganController->updatePelanggan($id, $nama, $alamat, $no_telepon, $email, $username, $password);
    ...
    ?>
        <div class="container mt-5">
            <form action="" method="post" class="edit-form">
                <?php
                foreach ($pelangganData as $d => $value) {
                ?>
